...
//               </div>
//             </Link>
//             <Link to="/super-admin/manage-employees">
//               <div
//                 className={`flex items-center w-[100%] my-8 ${
...
//               </div>
//             </Link>
//             <Link to="/super-admin/manage-orders">
//               <div
//                 className={`flex items-center w-[100%] my-8 ${
...
//               </div>
//             </Link>
//             <Link to="/super-admin/manage-store">
//               <div
//                 className={`flex items-center w-[100%] my-8 ${
//                   activeItem == "manage store"
//                     ? "border-r-2 border-r-[#FFE11B]"
//                     : ""
//                 }`}
//                 onClick={() => setActiveItem("manage store")}
//               >
//                 <IoStorefrontOutline
//                   className={`text-[24px] ${
//                     activeItem == "manage store"
...
//               </div>
//             </Link>
//             <Link to="/super-admin/manage-shop">
//               <div
//                 className={`flex items-center w-[100%] my-8 ${
//                   activeItem == "manage shop"
//                     ? "border-r-2 border-r-[#FFE11B]"
//                     : ""
//                 }`}
//                 onClick={() => setActiveItem("manage shop")}
//               >
//                 <IoCartOutline
//                   className={`text-[24px] ${
//                     activeItem == "manage shop"
...
//               </div>
//             </Link>
//             <Link to="/super-admin/appointment-calendar">
//               <div
//                 className={`flex items-center w-[100%] my-8 ${
