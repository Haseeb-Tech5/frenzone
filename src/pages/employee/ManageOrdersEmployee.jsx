...
// export default ManageOrdersEmployee;
import React from "react";
import "../employee/profit.css";
...
const ManageOrdersEmployee = () => {
  const pieChartData = {
    series: [30, 20, 40, 10],
    options: {
      labels: ["App Store Fee", "Revenue", "Gross Profit", "Net Profit"],
      colors: ["#ff0000", "#0000ff", "#00ff00", "#ff9700"],
      legend: {
        show: true,
        position: "left",
  ...
  return (
    <div className="profit-company">
      <div className="profit-company-setting">
        <div className="pr0fit-heading">
          <h2>Profit</h2>
        </div>
        <div className="chart-container">
          <div className="chart-set-path">
            <Chart
