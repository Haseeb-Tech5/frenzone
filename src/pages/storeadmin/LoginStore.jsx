...
const LoginStore = () => {
    return (
        <Grid container xs={12}>
            <Grid item lg={7} md={6} xs={12} align="center" className='min-h-[100vh] items-center w-full justify-center px-16 sm:px-32 py-20'>
                ...
                <Grid item xs={12} align="left" className="pt-12">
                    <h2 className='mt-8 text-[36px] font-[700] -tracking-[0.72px] leading-[56px]'>Login as Store Admin</h2>
